...

{
   ...
   \item \textbf{Fidelity}: to which extent the model imitates a black-box predictor.
   \item \textbf{Accuracy}: to which extent the model predicts unseen instances.
   
   \item \textbf{Fairness}: the model guarantees the protection of groups against discrimination.
...
\textbf{Complexity} is a measure of how difficult is to understand a model, it is inversely proportional to \textbf{interpretability}.

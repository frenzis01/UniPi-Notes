...
\begin{itemize}
   ...
   \item Funciton multiplication: $(f \cdot g)(x) \equiv f(x) \cdot g(x)$ corresponds to element-wise vector multiplication $\vec{f} \circ \vec{g}$
\end{itemize}

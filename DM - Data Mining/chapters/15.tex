...
\begin{paracol}{2}
   ...
   \begin{figure}[htbp]
      ...
      \textbf{Structure} given by the operations $(h, \cdot)$ while the parameters are the weights $\omega_{1\dots4}$.
      }
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=0.98\columnwidth]{images/15/NN.png}

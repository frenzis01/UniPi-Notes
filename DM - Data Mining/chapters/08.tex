...
\begin{itemize}
   ...
   \item e.g. for E, consider all itemsets with last item $DCBA$. In this way we get all the itemsets ending at $DE, CE, BE, AE$.
...
\begin{figure}[htbp]
   ...
   \caption{Searching for frequent itemsets}

...
Note that a $k$-sequence \ul{contains} $k$ \textbf{events}, \ul{not necessarily }$k$ \ul{\textbf{items}}!
...
// TODO demonstrated in the slides
...
% Therefore, if a sequence does not satisfy the max span constraint, none of its super-sequences will satisfy it.
    ...
    \item 
    max-gap\\
    If we remove instances, the gaps between remaining instances may increase.

...
\begin{itemize}
	\item Size. Test and validation set of
...
hungry, so this is a starting baseline.
	\item Distribution. Ideally, same
...
Classification. Classification tasks generally aim to measure a Hamming distance ($\ominus$)
between the gold labels, and the labels given by the model. Either measured as error or performance.

...
\ul{Models are not developed to aid on known experiences, rather on \textbf{unknown} ones.}
...
\begin{paracol}{2}
   ...
   \begin{itemize}
      \item \textbf{Underfit} - High bias, high variance.
...
Binary & $f1$-score & $\displaystyle\frac{2\cdot \textit{precision} \cdot \textit{recall}}{\textit{precision} + \textit{recall}}$ & Harmonic mean of precision and recall \\ \hline

...
It learns the rule set for the smallest class first, treating the rest as the negative class, then repeats the process with the next smallest class as the positive class.
...
\begin{itemize}
   ...
   \item After removing duplicate rules, C4.5rules uses class ordering instead of ordering individual rules.

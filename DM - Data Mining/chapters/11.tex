...
// TODO implement explanations. The section concerning the split positions and count matrix is rather obscure.
...
It is key that test data is \textbf{not} used in any way to create the classifier.

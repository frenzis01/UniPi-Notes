...
\note{Soy un estudiante italiano en Erasmus.
...
%    \begin{figure}[htbp]
%       \centering
%       \includegraphics{images/06/cybersit.png}
%       % \caption{}
%       \label{fig:06/cybersit}
%    \end{figure}
% \end{paracol}
...
El SIEM permite ``to flatten raw data'', y por tanto de \textbf{normalizar}, para salir una alerta más concisa y relevante.\\
...
Sin embargo, para velocizar el proceso de remediación, es posible \textbf{automatizar} las respuestas a los eventos, utilizando herramientas como \textsc{SOAR}, que tal vez se pueden integrar con el SIEM.\\
...
Y con respecto a la Fig. \ref{fig:06/cyvizTeam}, el orador no habla de esos equipos dedicados, sino que menciona las actividades que realizan, como la categorización de alertas, la investigación de una alerta o el análisis retrospectivo de un incidente.
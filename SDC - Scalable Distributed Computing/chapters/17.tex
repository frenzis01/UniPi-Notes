...
A shared-nothing architecture is a distributed computing architecture in which each node is self-sufficient and has its own private memory and storage.
The nodes communicate with each other by passing messages.
